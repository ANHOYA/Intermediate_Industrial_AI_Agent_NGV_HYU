    ...
    <aside className="w-80 bg-white border-r border-gray-200 h-full flex flex-col shadow-sm z-10">
      ...
      <div className="p-6 flex-1 overflow-y-auto space-y-8">
        ...
        <section>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-700">Saltlux API Key</label>
            <input
              type="password"
              value={apiKey}
              onChange={(e) => setApiKey(e.target.value)}
              className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:ring-2 focus:ring-hanyang focus:border-hanyang transition-colors"
        ...
        <section>
          ...
          <div className="space-y-3">
             <div className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-hanyang transition-colors text-center cursor-pointer"
                ...
                <p className="text-sm text-gray-600">Click to upload <code className="bg-gray-100 px-1 rounded">dev.csv</code></p>
                <input 
                  type="file" 
                  ref={fileInputRef} 
                  accept=".csv" 
      ...
      <div className="p-4 border-t border-gray-200 bg-gray-50">
        <p className="text-xs text-gray-400 text-center">
          Powered by Saltlux Luxia & React
        </p>
      </div>
    </aside>
  );
